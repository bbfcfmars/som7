...
export function Services() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setParallaxOffset((scrollProgress - 0.5) * 50);
    };
  ...
  return (
    <section ref={sectionRef} id="services" className="relative py-20 overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('https://api.builder.io/api/v1/image/assets/TEMP/5cda82c1be304edcc317307f8087d923078c83ad?width=2920')",
